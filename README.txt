...
Original pipeline script updated here and separated out into bash scripts to enable easy running and debugging. 
Some software has been updated to avoid bugs in older versions as long as they retain the informatic function intended in the original pipeline. 
Original paper reference: Pieper K, Tan J, Piccoli L, Foglierini M, Barbieri S, Chen Y, Silacci-Fregni C, Wolf T, Jarrossay D, Anderle M, Abdi A, Ndungu FM, Doumbo OK, Traore B, Tran TM, Jongo S, Zenklusen I, Crompton PD, Daubenberger C, Bull PC, Sallusto F, Lanzavecchia A. Public antibodies to malaria antigens generated by two LAIR1 insertion modalities. Nature. 2017 Aug 31;548(7669):597-601. doi: 10.1038/nature23670. Epub 2017 Aug 23. PMID: 28847005; PMCID: PMC5635981.
Available from https://pubmed.ncbi.nlm.nih.gov/28847005/ 
This optimised version of the pipline has been tested on original samples of the data from Pieper et al, and finds the same results plus an additonal couple of inserts! It also works for exploring sub-sections of the switch region. 

#Setting up the environment
#Linux
#Create a python 2.70 environment.
#Load the following versions of the software listed on 
...
it to be compatible with later versions of samtools that required the -o.
	# inclusion of some notes and code to switch between .fasta and .fa or .fastq and .fq extensions so the files are recognised correctly by sequential software.
